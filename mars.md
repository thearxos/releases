# <p align="center">🔴 ARXOS v2026.2 ~ Mars</p>
...
<p align="center">
  <img src="https://img.shields.io/badge/Kernel-LTS--Arch-blue?style=for-the-badge&logo=linux" />
  <img src="https://img.shields.io/badge/Base-Arch_Linux-1793D1?style=for-the-badge&logo=arch-linux" />
  <img src="https://img.shields.io/badge/Tools-BlackArch_2840+-red?style=for-the-badge&logo=kalilinux" />
  <img src="https://img.shields.io/badge/Desktop-XFCE_4.20-22D3EE?style=for-the-badge&logo=xfce" />
</p>
...
> **Built by hackers, for hackers** — featuring 2840+ pre-configured security tools from the BlackArch repository, custom performance optimizations, 54 custom Reversal themes, and a fast XFCE 4.20.2 desktop environment.

---

## 🆕 What's New in Mars

Compared to **v2026.1 ~ Venus**, this release brings significant improvements:

- **Desktop Migration** — Moved from KDE Plasma 6 to **XFCE 4.20.2** for a lighter, faster experience
- **Calamares Upgrade** — Now source-built **Calamares 3.4.1 (Qt6)** for a modern, reliable installer
- **Display Manager** — **SDDM** replaces the previous display manager for seamless login theming
- **Plank Dock** — A clean, macOS-style dock integrated into the desktop workflow
- **54 Custom Reversal Themes** — Massively expanded theming with 54 custom Reversal icon/GTK themes
- **9 Custom Tools** — New custom-built ArxOS tools including **WallPimp** and more
- **Expanded Arsenal** — Grown to **2,840+ BlackArch tools** (up from 2,800+)
- **LTS Kernel** — Switched to the **Linux LTS kernel** for improved stability and long-term support
...
### 🔐 Security Arsenal
- **2840+ BlackArch Tools** — Complete penetration testing suite from the BlackArch repository
- **Zero Bloat** — Only essential packages + security tools
- **Live Environment** — Boot and hack without installation
- **Calamares Installer** — Source-built Calamares 3.4.1 (Qt6) with disk encryption support

### 🚀 Performance Optimized
- **CPU Governor** — Custom C-based performance controller for maximum speed
- **LTS Kernel** — Linux LTS kernel for stability and long-term hardware support
- **Memory Efficient** — XFCE 4.20.2 delivers a lightweight desktop with minimal RAM overhead
- **Fast Boot** — Minimal startup time with systemd optimization

### 🎨 Beautiful Desktop
- **XFCE 4.20.2** — Lightweight, fast desktop with a clean, minimal layout
- **Plank Dock** — Elegant macOS-style application dock
- **SDDM Display Manager** — Custom ArxOS login screen matching the desktop theme
- **54 Custom Reversal Themes** — Extensive GTK/icon theme collection for deep personalization
- **WallPimp & More** — 9 custom-built ArxOS tools integrated into the system
...
**Total: 2840+ tools** - All pre-installed and configured, no installation needed.

### Pre-installed Applications

```
Base: ArchBang (Lightweight Arch Linux)
BlackArch: Complete repository (2840+ tools)
Desktop Environment: XFCE 4.20.2 (Minimalistic)
Display Manager: SDDM (custom ArxOS theme)
Dock: Plank (macOS-style application dock)
Terminal: XFCE Terminal with Oh-My-Zsh
...
Custom Tools: WallPimp + 8 more ArxOS tools
...
Mars ships with **54 custom Reversal themes** covering a wide range of color palettes and styles. All themes are pre-installed and immediately selectable from the XFCE Appearance settings — no additional downloads needed.

Themes include dark, light, and high-contrast variants with matching icon sets to create a fully cohesive desktop experience.

### SDDM Login Screen

The SDDM display manager is configured with a custom ArxOS theme that matches the overall desktop aesthetic, giving a consistent branded experience from boot to desktop.

### Plank Dock

Plank provides a clean, minimal macOS-style dock at the bottom of the screen. It comes pre-configured with the most commonly used security and system tools pinned for quick access.
...
- Custom ARXOS wallpaper (also manageable via WallPimp)
...
Mars introduces **9 custom-built tools** developed specifically for ArxOS workflows:

### WallPimp
A custom wallpaper manager built for ArxOS. Automatically fetches, organizes, and cycles through wallpapers with support for live previews and scheduled rotation.

```bash
wallpimp                  # Launch WallPimp GUI
wallpimp --random         # Set a random wallpaper
wallpimp --cycle 30       # Cycle wallpaper every 30 minutes
```

### Additional Custom Tools
Eight additional custom tools are included and accessible directly from the terminal and Plank dock. Run `arxos-tools` to list all available custom utilities with descriptions.
...
arxos-tools           # List all custom ArxOS tools
```
...
ArxOS ISO is approximately **30GB+** due to having all 2840+ BlackArch tools pre-installed.

**Download**: Available via the [ArxOS Portal](https://thearxos.github.io/portal.html)
...
ArxOS Mars ships with **source-built Calamares 3.4.1 (Qt6)** for a modern, stable installation experience.
...
4. **All Tools Already Installed**
   ...
   # All 2840+ tools are ready to use
   ```

5. **Explore Custom Tools**
   ```bash
   arxos-tools               # List all 9 custom ArxOS tools
   wallpimp                  # Try the new wallpaper manager
   ```
...
6. **Configure Network**
   ...
   # Or use the XFCE network manager panel applet
   ```
...
**SDDM Theme Issues:**
```bash
sudo systemctl restart sddm   # Restart display manager
```

**Plank Dock Not Showing:**
```bash
plank &                       # Launch Plank manually
# Or add Plank to XFCE session autostart via:
...
- **Total Tools**: 2840+ (Complete BlackArch repository)
- **Custom Tools**: 9 (ArxOS-built utilities)
...
- **Memory Usage**: ~350-450MB idle (XFCE 4.20.2)
...
- **Plank**: [GPL License](https://launchpad.net/plank)
- **Reversal Theme**: [GPL License](https://github.com/yeyushengfan258/Reversal-icon-theme)
...
- **XFCE Team** — For the fast, reliable 4.20.2 desktop environment
- **Calamares Team** — For the flexible Qt6 installer framework
...
- **Download**: [ArxOS Portal](https://thearxos.github.io/portal.html)
- **Documentation**: This README
...
wallpimp --random         # Set random wallpaper
